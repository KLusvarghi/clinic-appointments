  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>{mode === "create" ? "Adicionar Usuário" : "Editar Usuário"}</DialogTitle>
          <DialogDescription>
            {mode === "create"
        ...
        <form onSubmit={handleSubmit}>
              ...
              <Select value={formData.role} onValueChange={(value: User["role"]) => handleInputChange("role", value)}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="MANAGER">
                    <div className="flex flex-col items-start">
                      <span>Gerente</span>
                      <span className="text-xs text-muted-foreground">Gerencia equipes e processos</span>
                    </div>
                  </SelectItem>
                  <SelectItem value="EMPLOYEE">
                    <div className="flex flex-col items-start">
                      <span>Funcionário</span>
                      <span className="text-xs text-muted-foreground">Acesso limitado às funções</span>
                    </div>
                  </SelectItem>
                  <SelectItem value="COLLABORATOR">
                    <div className="flex flex-col items-start">
                      <span>Colaborador</span>
                      <span className="text-xs text-muted-foreground">Acesso específico por projeto</span>
                    </div>
                  </SelectItem>
                </SelectContent>
              </Select>
          ...
          <DialogFooter>
            ...
            <Button type="submit">{mode === "create" ? "Criar usuário" : "Salvar alterações"}</Button>
          </DialogFooter>
        </form>
      </DialogContent>
    </Dialog>
